  ...
  return (
    <div className="flex flex-col h-screen bg-[#121212] text-[#E0E0E0]">
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-4 p-4 overflow-hidden" style={{ minHeight: '500px' }}>
          {/* Map Area */}
          <div className="lg:col-span-2 bg-[#1A1A1A] rounded-lg border border-[#333] overflow-hidden h-full" style={{ minHeight: '500px' }}>
